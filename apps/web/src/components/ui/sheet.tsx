      ...
      >
        ...
        {showCloseButton && (
          <SheetPrimitive.Close
            ...
            render={
              <button className="absolute top-4 right-4 w-7 h-7 flex items-center justify-center rounded-lg text-[#71717A] hover:text-white hover:bg-[#1A1A1A] transition-colors" />
            }
          >
